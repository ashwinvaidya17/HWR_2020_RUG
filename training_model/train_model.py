...
def compile_model(X, class_size, loss, hidden_activation, optimizer):
...
def main():
    loss_array = "categorical_crossentropy"
    optimizer_array = "Adam"
    hidden_activation_array = "relu"
    epochs = 50
    ...
    alex_net = compile_model(X, class_size, loss_array, hidden_activation_array, optimizer_array)
